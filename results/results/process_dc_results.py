...
# problem_files = glob.glob('../dataset/clemens_problem_files/*.pddl')
# results_path = 'DeepCubeA/clemens_test_out/'

# problem_files = glob.glob('../dataset/clemens_problem_files/*.pddl')
# results_path = 'DeepCubeA_18/clemens_test_out/'

problem_files = glob.glob('../dataset/test_problem_files/**/*.pddl')
results_path = 'DeepCubeA/problems_test_out/'

print(problem_files)

# problem_files = glob.glob('../dataset/test_problem_files/**/*.pddl')
# results_path = 'DeepCubeA_18/problems_test_out/'
