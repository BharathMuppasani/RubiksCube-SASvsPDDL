...
problems_path = '/work/bharath/rubiks_cube/ipc-23-PDDL/dataset/problems/'

results_path = '/work/bharath/rubiks_cube/ipc-23-PDDL/results/PDDL-18/'
...
if __name__ == '__main__':
    ...
    problem_files = sorted(glob.glob(problems_path + '*.pddl'))
