...
problems_path = '/work/bharath/rubiks_cube/clemens_problem_files/'

results_path = '/work/bharath/rubiks_cube/clemens_results_12/'
...
def execute_planner(plan, domain, problem, output, search, planner_path):
    ...
    command_str = f'python fast-downward.py --overall-memory-limit 3584M --plan-file {plan} {domain} {problem} --search "{search}" > {output}'
